...
class WidgetAreas {
    ...
    public function register_widget_areas() {
        ...
        genesis_register_widget_area(
            array(
                'id'               => 'home-sidebar',
                'name'             => __( 'Home Sidebar', 'agrilife_extension' ),
                'description'      => __( 'This is the Home sidebar widget area. It appears in the right column of the home page. This widget area is not equipped to display any widget, and works best with menus and Genesis Featured Posts', 'agrilife_extension' ),
                '_genesis_builtin' => false,
            )
        );
